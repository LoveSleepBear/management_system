...
public class ZXingUtil {
    ...
    //    private static final int QRCOLOR = 0xED3E22; // 默认是黑色(二维码颜色)
//    private static final int BGWHITE = 0xFFFFFFFF; // 背景颜色
    private static final int BGWHITE = 0xFFFFFFFF; // 背景颜色(生成二维码背景颜色)
    ...
    public static void drawLogoQRCode(File logoFile, File codeFile, String qrUrl, String note) {
        try {
            ...
            if (StringUtils.isNotEmpty(note)) {
                ...
                BufferedImage outImage = new BufferedImage(400, HEIGHT + FONT_SIZE, BufferedImage.TYPE_4BYTE_ABGR);
                Graphics2D outg = outImage.createGraphics();
                // 画二维码到新的面板
                outg.drawImage(image, 0, 0, image.getWidth(), image.getHeight(), null);
                // 画文字到新的面板
                outg.setColor(Color.BLACK);
                outg.setFont(new Font("楷体", Font.BOLD, FONT_SIZE)); // 字体、字型、字号
...
//                    outg2.setFont(new Font("宋体", Font.BOLD, 30)); // 字体、字型、字号
                    outg2.setFont(new Font("楷体", Font.BOLD, FONT_SIZE)); // 字体、字型、字号
